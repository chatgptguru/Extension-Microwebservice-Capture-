  ...
  function injectCode(inject, active) {
    if (inject) {
      ...
      var toolbarinject =
        ...
        "' class=/></div><div id='eraser' class='tool' style='display: none' title='Eraser tool'><img src='" +
        chrome.extension.getURL("./assets/images/eraser.svg") +
        "'/></div><div id='text' class='tool' title='Text tool'><img src='" +
        ...
        "'/></div><div id='color-pckr' class='tool' title='Change the annotation color'><div id='color-icon'></div></div><div id='clear' class='tool' title='Delete all annotations'><img src='" +
        ...
        "'/></div><div id='cursor' style='display: none;' class='tool' title='Cursor settings'><img src='" +
        ...
        "'/></div><div id='settings' class='tool hide' title='Recording settings'><img src='" +
