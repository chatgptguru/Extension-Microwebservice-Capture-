...
// ---------------------
//
//  Object : pashootVideoRecord
//  Value  : pashootVideoData
...
//--------------------------------
//
//   Object : pashootScreenShot
//   Value  : pashootScreenShotData
...
chrome.runtime.onInstalled.addListener(function (details) {
  if (details.reason === "install") {
    chrome.tabs.create({ url: "https://pashoot.io/installation-successfull" });
  }
});
