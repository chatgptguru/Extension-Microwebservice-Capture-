  ...
  Annotate.prototype = {
    init: function() {
      ...
      if (self.options.bootstrap) {
        self.$tool = '<div id="img-tools" class="btn-group mb-1" role="group" style="bottom: -4.3rem;">' +
          '<div class="' + classPosition1 + '" data-toggle="buttons">' +
          '<button id="undoaction" title="Undo the last annotation"' +
          ' class="btn btn-sm btn-secondary ' + classPosition2 +
          ' annotate-undo">' +
        ...
        self.$tool += '<button class="btn btn-sm btn-secondary">' +
          '<input type="radio" name="' + self.toolOptionId +
          '" data-tool="rectangle"' +
          ' data-toggle="tooltip" data-placement="top"' +
          ' title="Draw an rectangle" style="position: fixed; opacity: 0;">' +
          ' <i class="fa fa-square-o fa-2x" aria-hidden="true"></i>' +
          '</button><button class="btn btn-sm btn-secondary">' +
          '<input type="radio" name="' + self.toolOptionId +
          '" data-tool="circle"' +
          ' data-toggle="tooltip"' +
          'data-placement="top" title="Write some text" style="position: fixed; opacity: 0;">' +
          '<i class="fa fa-circle-thin fa-2x" aria-hidden="true"></i>' +
          '</buttom><button class="btn btn-sm btn-secondary">' +
          '<input type="radio" name="' + self.toolOptionId +
          '" data-tool="text"' +
          ' data-toggle="tooltip"' +
          'data-placement="top" title="Write some text" style="position: fixed; opacity: 0;">' +
          ' <i class="fa fa-font fa-2x" aria-hidden="true"></i></button>' +
          '<button class="btn btn-sm btn-secondary">' +
          '<input type="radio" name="' + self.toolOptionId +
          '" data-tool="arrow"' +
          ' data-toggle="tooltip" data-placement="top" title="Draw an arrow" style="position: fixed; opacity: 0;">' +
          '<i class="fa fa-long-arrow-right fa-2x" aria-hidden="true"></i> </button>' +
          '<button class="btn btn-sm btn-secondary">' +
          '<input type="radio" name="' + self.toolOptionId +
          '" data-tool="pen"' +
          ' data-toggle="tooltip" data-placement="top" title="Pen Tool" style="position: fixed; opacity: 0;">' +
          ...
          'class="btn btn-sm btn-secondary ' + classPosition2 + ' annotate-redo">' +
          ' <i class="fa fa-repeat fa-2x" aria-hidden="true"></i></button>' +
          '</div></div>';
      } else {
